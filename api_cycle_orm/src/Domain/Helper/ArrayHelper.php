...
class ArrayHelper
{
     ...
     * @since 2.0.13
     */
    public static function setValue(array &$array, string|array|null $path, mixed $value): void
    {
        if ($path === null) {
            $array = $value;
            return;
     ...
     */
    public static function index(array $array, string|\Closure|null $key, string|array|null $groups = []): array
    {
        $result = [];
        $groups = (array) $groups;
     ...
     */
    public static function getColumn(array $array, int|string|array|\Closure $name, bool $keepKeys = true): array
    {
        $result = [];
        if ($keepKeys) {
     ...
     */
    public static function keyExists(string $key, array|ArrayAccess $array, bool $caseSensitive = true): bool
    {
        if ($caseSensitive) {
     ...
     */
    public static function multisort(array &$array, mixed $key, int|array $direction = SORT_ASC, int|array $sortFlag = SORT_REGULAR): void
    {
     ...
     * @return array
     */
    public static function recursiveSort(array &$array, callable|null $sorter = null): array
    {
